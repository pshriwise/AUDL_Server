getScoreboard = function( data ) {
	...
	home_img.src = "http://ec2-54-86-111-95.compute-1.amazonaws.com:4001/Logos/" + parsedData["hteam_id"] + ".png";
	var away_img = new Image();
	away_img.src = "http://ec2-54-86-111-95.compute-1.amazonaws.com:4001/Logos/" + parsedData["ateam_id"] + ".png";
	...
	table += "<tr>"
	table += "<td><img src='http://ec2-54-86-111-95.compute-1.amazonaws.com:4001/Logos/" + parsedData["hteam_id"] + ".png'></td>";
	table += "<td>" + parsedData["hteam"]  + "</td>";
	table += "<td>0</td><td>0</td><td>0</td><td>0</td>";
	table += "<td>" + parsedData["hscore"]  + "</td>";
	table += "</tr><tr>"
	table += "<td><img src='http://ec2-54-86-111-95.compute-1.amazonaws.com:4001/Logos/" + parsedData["ateam_id"] + ".png'></td>";
