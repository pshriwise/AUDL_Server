...
class League():
    ...
    def return_schedules(self):
        ...
        for div in self.Divisions:
            game_sched = self.return_games(self.Divisions[div],days_ahead=7,days_behind=0,scores=False)
    ...
    def return_scores_page(self):       
        ...
        data_out = []
        for div in self.Divisions:
            game_scores = self.return_games(self.Divisions[div],days_ahead=365,days_behind=14,scores=True)
